/* =======================================================
   SHUKUDAI 2.2.2 - Seguimiento y reinicio diario
   Mejoras: control de errores, UX y consistencia
   ======================================================= */
...
btnReset.addEventListener('click',()=>{
  if(confirm('¿Seguro que quieres reiniciar todo el marcador semanal?')){
    diasSemana.forEach(dia=>progreso[dia]={tareas:{},puntosTotales:0,minutosTotales:0});
    guardarProgreso();
    renderDias();
...
function calcularNivel(puntos){ return Math.floor(puntos/150)+1; }
